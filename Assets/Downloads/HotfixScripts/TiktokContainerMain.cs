...
namespace Game
{
    ...
    public class TiktokContainerMain : ContextRoot
    {
        ...
        //    container.Bind<ViewController>().ToSingleton<BackgroundUnitsController>().As("Castle");
        //    container.Bind<ViewController>().ToSingleton<UIStartMenuController>().As("Castle");
