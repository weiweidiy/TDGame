...
namespace Tiktok
{
    public class UIPanelLevelList : UIPanelBase<UIPanelLevelListProperties>
    {
        ...
        protected override void OnPanelRefresh(UIPanelLevelListProperties properties)
        {
            scrollerLevelListDel.Reload(Properties.dataLevelList);
        }
    }

    public class UIPanelLevelListProperties : PanelProperties
    {
